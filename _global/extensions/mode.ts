 ...
 *
 * Replaces the standalone plan-mode/ and loop.ts extensions with a single
 * extension that provides keyboard-driven cycling between modes.
 *
 * Shortcut: Ctrl+M — cycle through modes (Normal → Plan → Loop)
